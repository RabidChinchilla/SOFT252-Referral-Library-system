 ...
 * @author Gearing
 */
public class userReminders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(remindersTable);
        ...
        jButton2.setText("Clear selected reminders");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (Client user : userList){
            for (Object reminder : user.Reminders){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userReminders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
